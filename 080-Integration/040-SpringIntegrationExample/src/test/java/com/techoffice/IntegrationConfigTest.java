...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {Application.class, IntegrationConfigTest.MockBeanConfig.class})
...
//        Mockito.verify(testService, atLeast(1)).handle(anyString(), any());
    }
